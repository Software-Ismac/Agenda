...
const RedirectToIsmac = () => {
  useEffect(() => {
    window.location.replace("https://ismac.edu.ec/SistemaOperativoWeb/");
  }, []);

  return <div>Redirigiendo a ISMAC...</div>;
};

export default RedirectToIsmac;
// export default function CallCenter() {
//   const res = "https://ismac.edu.ec/SistemaOperativoWeb/";
